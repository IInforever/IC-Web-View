      ...
      <div v-if="passwordRequired">
        <el-form ref="form" :model="form" :rules="rules">
          <el-form-item label="Password" prop="password">
            <el-input v-model="form.password" placeholder="Input Password" show-password></el-input>
          </el-form-item>
          <el-button :loading="submitLoading" type="primary" @click="getWithPassword">submit</el-button>
        </el-form>
      </div>
      <div v-else>
        <el-descriptions :column="large?2:1" border size="small">
          ...
          <el-descriptions-item>
            ...
            <el-tag class="meta-tags" size="small">{{ paste.isPrivate ? "private" : "public" }}</el-tag>
            <el-tag v-if="paste.hasPasswd" class="meta-tags" size="small" type="success">
              <el-icon>
                <Lock/>
              </el-icon>
              password
...
<script setup>
import {Calendar, Link, Lock, Operation, UserFilled} from "@element-plus/icons-vue";
...
export default {
            ...
            params: {
              ...
              .then((response) => {
                ...
                if (response.data.uid)
                  this.getUsername(response.data.uid)
              })
              .catch((error) => {
  ...
  mounted() {
    ...
    axios.get("/api/pastes/" + id, config)
        .then((response) => {
