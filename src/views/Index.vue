...
<template>
  <BasicFramework :auth="auth"
                  ...
                  @logout="logout">
    <el-form ref="inputs" :model="postForm" :rules="rules" :status-icon="false" style="text-align: left">
      ...
      <el-form-item label="Private" label-width="80px">
        <el-tooltip :disabled="auth === 0" content="login require" effect="light" placement="right">
          <el-switch v-model="isPrivate" :disabled="auth !== 0 || isAnonymous" active-color="#13ce66"
                     active-text="Y" inactive-text="N" inline-prompt></el-switch>
        </el-tooltip>
      </el-form-item>

      <el-form-item v-if="auth === 0" label="Anonymous" label-width="80px">
        <el-switch v-model="isAnonymous" :disabled="auth !== 0" active-color="#13ce66"
      ...
      <el-form-item style="text-align: center">
        <el-button :loading="isButtonLoading" type="primary" @click="createPaste">Create</el-button>
      </el-form-item>
    </el-form>
  </BasicFramework>
</template>
